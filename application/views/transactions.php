                        ...
                        <table class='table-striped' id='transactions_list'
                          ...
                          <thead>
                            <tr>
                              ...
                              <th data-field="status" data-sortable="true"><?=$this->lang->line('status')?$this->lang->line('status'):'Status'?></th><th data-field="invoice" data-sortable="true"><?=$this->lang->line('invoice')?htmlspecialchars($this->lang->line('invoice')):'Invoice'?></th>
                            </tr>
                          </thead>
                        </table>
                      </div>
